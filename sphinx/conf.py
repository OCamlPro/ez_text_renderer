...
# -*- coding: utf-8 -*-
#
# ez_text_renderer documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'ez_text_renderer.tex', 'ez_text_renderer Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'ez_text_renderer', 'ez_text_renderer Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ez_text_renderer', 'ez_text_renderer Documentation',
     author, 'ez_text_renderer', 'One line description of project.',
     'Miscellaneous'),
]
