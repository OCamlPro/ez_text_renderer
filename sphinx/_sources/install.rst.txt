...
If :code:`ez_text_renderer` is available in your opam repository, you can just call::

  opam install ez_text_renderer

Build and install with :code:`dune`
-----------------------------------

Checkout the sources of :code:`ez_text_renderer` in a directory.
